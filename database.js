...
async function addPose(pose) {
    await pool.query("INSERT INTO poses(title, difficulty_level, image, description) VALUES(?, ?, ?, ?)", [pose.title, pose.difficulty_level, pose.image, pose.description])
}
